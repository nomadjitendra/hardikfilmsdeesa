                ...
                a.attr("data-preinit", !0), a.on("click." + c, function(c) {
                    if (!d.$slider.hasClass("sp-swiping")) {
                        ...
                        var e, f, g, h, i, j, k, l = a.attr("href"),
                            ...
                            n = a.children("img").attr("height"); - 1 !== l.indexOf("youtube") || -1 !== l.indexOf("youtu.be") ? f = "youtube" : -1 !== l.indexOf("vimeo") && (f = "vimeo"), g = "youtube" === f ? /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/ : /http:\/\/(www\.)?vimeo.com\/(\d+)/, h = l.match(g), i = h[2], j = "youtube" === f ? "http://www.youtube.com/embed/" + i + "?enablejsapi=1&wmode=opaque" : "https://player.vimeo.com/video/" + i + "?api=1", k = l.split("?")[1], "undefined" != typeof k && (k = k.split("&"), b.each(k, function(a, b) {
                            -1 === b.indexOf(i) && (j += "&" + b)
    ...
    e.fn.extend({
        retinise: function(t) {
            ...
            e(this).each(function() {
                ...
                t.css("display", "none");
                if (t.attr(r.srcattr)) {
                    var o = t.attr(r.srcattr),
                        u = t.attr(r.altattr),
                        a = t.attr(r.retattr);
                    if (s === !0) {
                        t.attr(r.retattr) ? t.attr({
                            src: a,
                            alt: u
                        }) : t.attr({
